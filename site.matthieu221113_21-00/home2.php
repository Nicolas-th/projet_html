...
<div id="sidebar_edit-profile">
	...
	<?php if(!$user) { ?>
	<div id="changeAvatar">
		<form method="post" action="includes/edit-profile.inc.php?id=<?=$profile['id'] ?>" enctype='multipart/form-data'>
	...
	<form method="post" action="includes/edit-profile.inc.php?id=<?=$profile['id'] ?>" id="editProfile">
	...
	<form method="post" action="includes/edit-profile.inc.php?id=<?=$profile['id'] ?>" id="changePassword">
