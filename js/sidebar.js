  ...
  $("header div:nth-child(3)").click(function(){
  	...
  	if($("header div:nth-child(4)").hasClass('actif')){

  		$("#sidebar_profile").hide(0);
	  	$("#sidebar_edit").show(0);
		$("header div:nth-child(3)").addClass('actif');
		$("header div:nth-child(4)").removeClass('actif');
  ...
  $("header div:nth-child(4)").click(function(){

  	if($("header div:nth-child(3)").hasClass('actif')){

	  	$("#sidebar_edit").hide(0);
		$("#sidebar_profile").show(0);
		$("header div:nth-child(4)").addClass('actif');
		$("header div:nth-child(3)").removeClass('actif');
...
$(".edit_added_places").click(function(){
	$("#popup_right ul li img").attr({ src: "../assets/img/trash.svg", width: "20" });
});
...
/*********masquer le enregistrer***********/

$("#save_infos").click(function(){
