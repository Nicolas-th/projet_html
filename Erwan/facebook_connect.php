<?php
  ...
  define('FACEBOOK_returnURL','http://illio.fr/projet_html/tests_erwan/facebook_connect.php');
  ...
  if ($user) {
    try {
      ...
      $response = file_get_contents('https://graph.facebook.com/'.$userid.'/friends?fields=id,name,locations,interests&access_token='.$jeton);
      */
      //var_dump($response);
