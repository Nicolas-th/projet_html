$(function(){
  ...
  if(navigator.geolocation) {
    ...
    survId = navigator.geolocation.watchPosition(suivi_position);
  }
  ...
  function suivi_position(position){
    ...
    if(typeof(position_reel)=='undefined') {
        position_reel = new google.maps.Marker({
          position: latlng,
          map: map,
          title:"Vous êtes ici !"
        });
